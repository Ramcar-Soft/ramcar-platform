...
insert into public.profiles (user_id, tenant_id, full_name, role, email)
values (
  'b0000000-0000-0000-0000-000000000001',
  'a0000000-0000-0000-0000-000000000001',
  'Admin Demo', 'admin', 'admin@ramcar.dev'
);
...
values (
  'b0000000-0000-0000-0000-000000000002',
  'a0000000-0000-0000-0000-000000000001',
  'Guard Demo', 'guard', 'guard@ramcar.dev'
);
...
values (
  'b0000000-0000-0000-0000-000000000003',
  'a0000000-0000-0000-0000-000000000001',
  'Resident Demo', 'resident', 'resident@ramcar.dev'
);
