  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          {isLoadingVehicles ? (
            ...
            <div className="space-y-2">
              <p className="text-sm text-muted-foreground">{tVehicles("noVehicles")}</p>
              {onAddVehicle && (
      ...
      <div className="space-y-3">
        ...
        <Textarea value={notes} onChange={(e) => setNotes(e.target.value)} placeholder={t("notes.placeholder")} rows={3} />
      </div>
